 ...
 */
	...
	public void startToPlay() {
		...
		new Load();               //Read the file and load cards into deck
...
//		checkShuffle();           //check if the deck is successfully shuffled
	}
 ...
 */
	public void removePlayer() {
		if(playerList.get(0).getPlayerDeck().size() == 0) {
			YourDeckSize = 0;
		}
	...
	public void checkGameEnd() {
		...
		if(playerList.size() == 1) {
			...
			JDBCUtils.updateALLGAMES(numOfGames, roundWinnerIndex, nRound, nDraws);
			gameResult();
			
			nRound = 1;         //Reset number of rounds
			numOfGames++;       //Increase number of games
